...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FabricCanvas = __webpack_require__(298);

	var _FabricCanvas2 = _interopRequireDefault(_FabricCanvas);

	var _PixiCanvas = __webpack_require__(299);

	var _PixiCanvas2 = _interopRequireDefault(_PixiCanvas);

	var _Uploader = __webpack_require__(300);

	var _Uploader2 = _interopRequireDefault(_Uploader);

	var _Aframe = __webpack_require__(301);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.onZoomIn = function () {
	      var zoomLevel = _this.state.zoomLevel += 0.1;
	    ...
	    _this.setImage = function (img) {
	      _this.setState({ img: img });
	    };

	    _this.setRendered2D = function (imgDataUrlCollection) {
	      _this.setState({ rendered2D: imgDataUrlCollection });
	    };
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { className: "row" },
	        React.createElement(_Aframe2.default, { rendered2D: this.state.rendered2D })
	      );
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	var FabricCanvas = function (_React$Component) {
	  _inherits(FabricCanvas, _React$Component);

	  function FabricCanvas(props) {
	    _classCallCheck(this, FabricCanvas);

	    var _this = _possibleConstructorReturn(this, (FabricCanvas.__proto__ || Object.getPrototypeOf(FabricCanvas)).call(this, props));

	    _this.componentWillReceiveProps = function (nextProps) {
	      var C = _this.fabricCanvas;
	      var H = C.height;
	      var W = C.width;

	      if (nextProps.imgUrl !== _this.props.imgUrl) {
	        ...
	        fabric.Image.fromURL(nextProps.imgUrl, function (oImg) {
	          oImg.setOptions({
	            selectable: false,
	            evented: false,
	            opacity: 0.9,
	        ...
	        var line1 = makeLine([0, H, 0.25 * W, 0.75 * H]),
	    ...
	    _this.export = function () {
	      ...
	      image.onload = function () {
	        ...
	        var context = _this.refs.editCanvasRef.getContext("2d");
	        for (var i = 0; i <= CH; ++i) {
	          // if (i % 10 === 0) {
	          ...
	          context.drawImage(image, IW / CW * (CP.topLeftX + (CP.bottomLeftX - CP.topLeftX) * i / CH), IH / CH * (CP.topLeftY + (CP.bottomLeftY - CP.topLeftY) * i / CH), IW / CW * (CP.topRightX - CP.topLeftX + (CP.bottomRightX - CP.bottomLeftX - CP.topRightX + CP.topLeftX) * i / CH), IH / CH, 0, i, CW, 1);
	        }

	        var imgDataUrl = _this.refs.editCanvasRef.toDataURL();
	        fabric.Image.fromURL(imgDataUrl, function (oImg) {
	          oImg.setOptions({
	            selectable: false,
	            evented: false,
	            opacity: 0.9,
	          ...
	          _this.fabricEditCanvas.setBackgroundImage(oImg);
	          _this.fabricEditCanvas.renderAll();

	          _this.setRendered2D();
	        });
	        // this.fabricEditCanvas.renderAll();
	      };
	      image.src = _this.props.imgUrl;
	    };

	    _this.setRendered2D = function () {

	      _this.props.setRendered2D({
	        middle: _this.fabricCanvas.deactivateAll().toDataURL({
	          format: "png",
	          multiplier: 2.56
	        }),
	        bottom: _this.fabricEditCanvas.deactivateAll().toDataURL({
	          format: "png",
	          multiplier: 2.56
	        })
	      });
	    ...
	    _this.fabricCanvas = new fabric.Canvas();
	    _this.fabricEditCanvas = new fabric.Canvas();
	    _this.image = null;
	    _this.H = 100;
	    _this.W = 100;
	    return _this;
	  ...
	  _createClass(FabricCanvas, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        null,
	        React.createElement("button", { onClick: this.export }),
	        React.createElement(
	          "div",
	          { className: "row" },
	          React.createElement("canvas", { ref: "canvasRef" }),
	          React.createElement("canvas", { ref: "editCanvasRef" })
	        )
	      );
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	var Canvas = (_temp = _class = function (_React$Component) {
	  ...
	  _createClass(Canvas, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        "div",
	        { className: "app-root" },
	        React.createElement("div", { className: "game-canvas-container", ref: "gameCanvas" })
	      );
	    }
	  }]);
	  ...
	  this.updateZoomLevel = function (props) {
	    _this2.stage.scale.x = props.zoomLevel;
	    _this2.stage.scale.y = props.zoomLevel;
	  };

	  this.animate = function () {
	    while (_this2.stage.children[0]) {
	      _this2.stage.removeChild(_this2.stage.children[0]);
	    }
	    // this.stage.addChild(
	    //   new PIXI.Sprite(PIXI.loader.resources[this.props.imgUrl].texture)
	    // );
	    // create a new Sprite from an image path
	    var bunny = PIXI.Sprite.fromImage(_this2.props.imgUrl);

	    // center the sprite's anchor point
	    bunny.anchor.set(0.5);

	    // move the sprite to the center of the screen
	    bunny.x = _this2.renderer.width / 2;
	    bunny.y = _this2.renderer.height / 2;

	    bunny.scale.x = bunny.scale.y = 0.05;
	    bunny.interactive = true;
	    // Pointers normalize touch and mouse
	    bunny.on("pointerdown", _this2.drawline);

	    _this2.stage.addChild(bunny);
	  };
	  ...
	  function Uploader(props) {
	    ...
	    _this.onFileChange = function (e) {
	      ...
	      reader.onload = function () {
	        ...
	        _this.props.setImage(reader.result);
	      };
	  ...
	  _createClass(Uploader, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        null,
	        React.createElement("img", { src: this.state.imgUrl, width: "100px", height: "100px" }),
...
/***/ (function(module, exports) {
	...
	var Aframe = function (_React$Component) {
	  ...
	  function Aframe(props) {
	    ...
	    _this.getA = function () {
	      return React.createElement(
	        ...
	        React.createElement(
	          "a-entity",
	          { position: "-11.033 19.453 -6.567", rotation: "-10 -45 0" },
	        ...
	        React.createElement("a-light", { type: "ambient", color: "#bbb" }),
	        React.createElement("a-light", {
	          "class": "point-light",
	          color: "#ccc",
	          position: "0 30 0",
	          distance: "100",
	        ...
	        React.createElement(
	          "a-assets",
	          null,
	          React.createElement("a-mixin", { id: "cube", geometry: "primitive: box" }),
	          React.createElement("a-mixin", { id: "cube-hovered", material: "color: magenta" }),
	          React.createElement("a-mixin", { id: "cube-selected", material: "color: cyan" }),
	          React.createElement("a-mixin", { id: "red", material: "color: red" }),
	          React.createElement("a-mixin", { id: "green", material: "color: green" }),
	          React.createElement("a-mixin", { id: "blue", material: "color: blue" }),
	          React.createElement("a-mixin", { id: "yellow", material: "color: yellow" }),
	          React.createElement("a-mixin", { id: "sphere", geometry: "primitive: sphere" }),
	          React.createElement("a-mixin", {
	            id: "box",
	        ...
	        React.createElement("a-sky", { color: "#222" }),
	        React.createElement(
	          "a-entity",
	          { position: "0 15 -15", "class": "clickable" },
	        ...
	        React.createElement("a-entity", { "rain-of-entities": "", id: "ball-container", "class": "clickable" })
	      );
	    };
	  ...
	  _createClass(Aframe, [{
	    ...
	    value: function componentWillMount() {
	      AFRAME.registerSystem("utility", {
	        ...
	        saveObject: function saveObject(el) {
	          this.selection = el;
	        },
	        loadObject: function loadObject() {
	          return this.selection;
	        },
	        clearSavedObject: function clearSavedObject() {
	          this.selection = null;
	        },
	        hideObject: function hideObject(id) {
	        ...
	        showObject: function showObject(id) {
	      ...
	      */
	      AFRAME.registerComponent("rain-of-entities", {
	        ...
	        reset: function reset() {
	          ...
	          this.balls.forEach(function (B) {
	            B.body.position.copy(_this2.getPosition(B.components.grabbable.data.index));
	        ...
	        spawn: function spawn() {
	          ...
	          var _loop = function _loop(i) {
	            var B = document.createElement(D.tagName);

	            B.setAttribute("position", _this3.getPosition(i));
	            B.setAttribute("grabbable", "index: " + i + "; url: " + D.descriptions[i].url + "; label: " + D.descriptions[i].label);
	            ...
	            T.setAttribute("position", _this3.getPosition(i, "text"));
	            T.setAttribute("wrap-count", 80);
	            T.setAttribute("text", "color: white; align: center; width: 50; value: " + D.descriptions[i].label);
	            _this3.labels.push(T);

	            setTimeout(function () {
	              _this3.el.appendChild(B);
	              _this3.el.appendChild(T);
	              // Return the ball if it falls down
	              setInterval(function () {
	                if (B.body.position.y > 0) return;
	                B.body.position.copy(_this3.getPosition(i));
	                B.body.velocity.set(0, 0, 0);
	                B.body.angularVelocity.setZero();
	              }, D.lifetime);
	            }, i * D.interval);
	        ...
	        getPosition: function getPosition(i, type) {
	          return type === "text" ? {
	      ...
	      AFRAME.registerComponent("grabbable", {
	        ...
	        grab: function grab() {
	          if (!document.querySelector("a-scene").systems["utility"].loadObject()) {
	            document.querySelector("a-scene").systems["utility"].saveObject(this.el);
	            var force,
	                el = this.el,
	      ...
	      AFRAME.registerComponent("aimable", {
	        ...
	        aimThisAndThrow: function aimThisAndThrow() {
	          var _this4 = this;

	          var ACC = this.data.accuracy;
	          var ball = document.querySelector("a-scene").systems["utility"].loadObject();
	          if (!ball) {
	            ...
	            var basket = this.el.sceneEl.querySelector("#basket");
	            this.sourceEl = this.el.sceneEl.querySelector("#camera");
	            ...
	            var jumpForce = new CANNON.Vec3(0, 1, 0);
	            jumpForce.normalize();
	            ...
	            setTimeout(function () {
	              // Throw
	              var force = basket.body.position.vsub(ball.body.position).vadd(new CANNON.Vec3(ACC - Math.random() * ACC * 2, 30 + ACC - Math.random() * ACC * 2, ACC - Math.random() * ACC * 2));
	              force.normalize();
	              force.scale(_this4.data.shootForceScale, force);
	              ball.body.applyImpulse(force, ball.body.position);
	              // Random Spin
	              ball.body.angularVelocity.set(ACC * 10 - Math.random() * ACC * 20, ACC * 10 - Math.random() * ACC * 20, ACC * 10 - Math.random() * ACC * 20);
	            }, 300);
	            ...
	            // In/out detection
	            var posBefore = new CANNON.Vec3();
	            var posAfter = new CANNON.Vec3();
	            var intervalId = setInterval(function () {
	              posBefore.copy(posAfter);
	              posAfter.copy(ball.body.position);
	              if (!posBefore.isZero() && !posAfter.isZero() && posBefore.y >= 15 && posAfter.y < 15) {
	                var avgX = (posBefore.x + posAfter.x) / 2;
	                var avgZ = (posBefore.z + posAfter.z) / 2;
	                if (avgX >= -2 && avgX <= 2 && avgZ >= -17 && avgZ < -13) {
	                  console.log("in");

	                  document.querySelectorAll(".point-light").forEach(function (el) {
	                    el.setAttribute("color", "gold");
	                  });
	                  setTimeout(function () {
	                    document.querySelector("#camera").setAttribute("active", true);
	                    document.querySelector("#camera-2").setAttribute("active", false);
	                  }, 500);

	                  setTimeout(function () {
	                    document.querySelector("a-scene").systems["utility"].showObject("#banner-success");
	                    document.querySelector("a-scene").systems["utility"].hideObject("#ball-container");
	                    document.querySelector("#banner-success").setAttribute("navigate", "label: " + ball.components.grabbable.data.label + "; url: " + ball.components.grabbable.data.url);
	                  }, 1500);
	            ...
	            // Clear selection
	            document.querySelector("a-scene").systems["utility"].clearSavedObject();
	          }
	        }
	      });
	      ...
	      AFRAME.registerComponent("navigate", {
	        ...
	        update: function update() {
	          ...
	          T.setAttribute("value", "Congratulations! Visit " + this.data.label + "?");
	          this.el.appendChild(T);

	          this.insertLeftButton();
	          this.insertRightButton();
	        },
	        insertLeftButton: function insertLeftButton() {
	          var btn = document.createElement("a-icosahedron");
	        ...
	        insertRightButton: function insertRightButton() {
	          var btn = document.createElement("a-icosahedron");
	        ...
	        clickRightButton: function clickRightButton() {
	          ...
	          document.querySelector("a-scene").systems["utility"].hideObject("#banner-success");
	          document.querySelector("a-scene").systems["utility"].showObject("#ball-container");
	          document.querySelector("[rain-of-entities]").components["rain-of-entities"].reset();
	        }
	      });
	          ...
	          if (isFloating) {
	            ...
	            targets = [].slice.call(targets).forEach(function (el) {
	              var position = new CANNON.Vec3().copy(el.getAttribute("position")),
	                  impulse = new CANNON.Vec3(0.25 * data.force * Math.random(), 1.0 * data.force * Math.random() + 1.5, 0.25 * data.force * Math.random());
